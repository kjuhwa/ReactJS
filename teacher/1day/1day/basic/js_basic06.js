// ES6 모던 자바스크립트
// 객체,배열에대한 추가기능
// 구조 분해, 객체 리터널 개선, 스프레드 연산 ...
// ===============================================
var food = {
    bread:'크로와상',
    meat:'소고기',
    cheese:'체다치즈',
    rices:['돈까스덮밥','불고기덥밥','김치볶음밥']
}
// 기존에는 객체.맴버로 접근하여 데이터를 사용
console.log(food.cheese, food.rices[1]);
// 변수로 받아서 사용하고 싶다
// 원본은 그대로 두고 사본을 만들어서 구조분해 처리된다
var {meat, cheese} = food
console.log(cheese, meat, food);
meat = '돼지고기'
console.log(cheese, meat, food);
// =========================================================
// 구조 분해 응용 => 함수 인자로 사용 
...
// 돈까스 덥밥
console.log(a);
// 김치볶음밥 (배열 구성원이 많을 경우 일일 ,,,, 치는것은 비효율적)
var [,,c] = food.rices
console.log(c);
// ========================================================
// 객체 리터럴 개선
...
console.log(lastFood2, food.rices);
