...
- 내용
 -> jsonplaceholder.typicode.com 요청하여 posts와 comment를 가져와서 화면 처리
...
2. newui 프로젝트 추가 모듈 구성
 > npm install --save axios semantic-ui-css semantic-ui-react promise-polyfill
 > promise 패턴이 미지원되는 IE 브라우저를 위해서 처리를 해줘야 함
